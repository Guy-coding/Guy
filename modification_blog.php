...
if (isset($_POST['submit'])) {
    ...
    // Update article
    $sql = "UPDATE article SET titre = :titre, description = :description, image = :image, auteur = :auteur WHERE id = :id";
    $stmt = $conn->prepare($sql);
...
<div class="container my-5">
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="tags" name="tags" placeholder="Séparez les tags par des virgules" value="<?php echo $tags  ?? ''; ?>">
        </div>
