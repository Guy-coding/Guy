...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100">
      ...
      <div class="card mb-4">
            <div class="card-header"><strong>les client</strong><span class="small ms-1">connectee</span></div>
            <div class="card-body">
...
try {
    ...
    <div class='card'>
        <div class='card-body'>
        <h3 class='blue'>Les informations du client</h3>
        <div class='d-flex align-items-center'>
                 <strong>   <h5 class='card-title me-2'>Nom: </h5> </strong> 
                    <p class='card-text'>" . $row["name"] . "</p>
                </div>
            <div class='d-flex align-items-center'>
                    <h5 class='card-title me-2'>Email: </h5>
                    <p class='card-text'>" . $row["email"] . "</p>
                </div>
                <div class='d-flex align-items-center'>
                    <h5 class='card-title me-2'>Objet: </h5>
                    <p class='card-text'>" . $row["objet"] . "</p>
                </div>
                <div class='d-flex align-items-center'>
                    <h5 class='card-title me-2'>Selecteur: </h5>
                    <p class='card-text'>" . $row["ma_selecteur"] . "</p>
                </div>
                <div class='d-flex align-items-center'>
                    <h5 class='card-title me-2'>Acceptation: </h5>
                    <p class='card-text'>" . $row["acceptation"] . "</p>
                </div>
                <div class='d-flex align-items-center'>
                    <h5 class='card-title me-2'>Message: </h5>
                    <p class='card-text'>" . $row["message"] . "</p>
                </div>
                <div class='d-flex align-items-center'>
                    <h5 class='card-title me-2'>Sujet: </h5>
                    <p class='card-text'>" . $row["subject"] . "</p>
                </div>
             <button class='btn btn-danger' data-id='" . $row['id'] . "'>Supprimer</button>
