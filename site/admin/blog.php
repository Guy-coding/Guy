...
<div class="container">
  ...
  <div class="card h-100">
    <img class="card-img-top" src="image/<?php echo $article['image']; ?>" alt="">
    <div class="card-body d-flex flex-column">
      ...
      <div class="mt-auto d-flex justify-content-end">
        ...
        <!-- <a class="btn btn-primary" href="modification_blog">Modifier</a> -->
        <a href="modification_blog" class="btn btn-primary me-2">
  Modifier
</a>
        <a class="btn btn-primary" href="detailleblog?id=<?php echo $article['id']; ?>">Détails</a>
      </div>
    </div>
      </div>
    </div>
