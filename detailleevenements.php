...
try {
    ...
    // Récupérer les informations de l'events
    $events_id = $_GET['id'];
    $requete = "SELECT * FROM evenements WHERE id = :id";
    $stmt = $conn->prepare($requete);
    $stmt->bindParam(':id', $events_id);
    $stmt->execute();
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <h5 class="card-title"><?php echo $events['titre']; ?></h5>
        ...
        <a href="modification_evenements.php?id=<?php echo $events_id ?>" class="btn btn-primary me-2">Modifier</a>
      </div>
      </div>
    </div>
  </div>
